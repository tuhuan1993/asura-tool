package com.asura.tools.cjf.imp;
...
import com.asura.tools.cjf.config.LoadConfig;
import com.asura.tools.cjf.entity.Char;
import com.asura.tools.cjf.utils.CharFilter;
import com.asura.tools.cjf.utils.IOUtil;

public class ChineseJFImpl implements ChineseJF {
	public static Char[] charMapList_Fan2Jan = null;

	public boolean initialized() {
		return (charMapList_Fan2Jan != null);
	}
